...
`base-ui`, `better-auth`, `brainstorm`, `bullmq`, `bun`, `clickhouse`, `compound-ui`, `d3`, `drizzle-orm`, `effect`, `elysia`, `evlog`, `handoff`, `intlayer`, `jsdoc`, `kafka`, `legend-state`, `loop`, `motion`, `oxfmt`, `oxlint`, `permix`, `plain-language`, `playwright`, `react`, `research`, `ship-product`, `simplify-layout`, `storybook`, `subagents`, `tailwind`, `tailwind-variants`, `tanstack-charts`, `tanstack-form`, `tanstack-hotkeys`, `tanstack-query`, `tanstack-router`, `tanstack-start`, `tanstack-store`, `tanstack-table`, `testcontainers`, `tsdown`, `turborepo`, `ultraplan`, `unslop-code`, `unslop-copywriting`, `unslop-docs`, `unsmell`, `visx`, `vite`, `vitest`, `zod`
